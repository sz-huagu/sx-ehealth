...
public class Des {
	...
	// "kEHrDooxWHCWtfeSxvDvgqZq";
	private static final String	PASSWORD_CRYPT_KEY	= "D139D2CD5533348704CE54436E6684F9";
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 
		 * String testStr=""+curDate.getTime()/1000;
		 * 
		 * //String md5Password = "202cb962ac59075b964b07152d234b70"; String str
		 * = Des.encrypt(testStr);
		 * 
		 * System.out.println("date string: " + testStr);
		 * System.out.println("str: " + str); str = Des.decrypt(str);
		 * System.out.println("str: " + str);
		 */
		// 1432027866
		System.out.println(Des.decrypt("5E189D98820A9BDD151CF8E2ADA33AC1"));
	}
